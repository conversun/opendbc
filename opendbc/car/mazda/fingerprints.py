...
# TI variants share identical FW with base GEN1 (TI is hardware add-on, no ECU firmware changes)
FW_VERSIONS[CAR.MAZDA_CX5_TI] = FW_VERSIONS[CAR.MAZDA_CX5]
FW_VERSIONS[CAR.MAZDA_CX9_TI] = FW_VERSIONS[CAR.MAZDA_CX9]
FW_VERSIONS[CAR.MAZDA_3_TI] = FW_VERSIONS[CAR.MAZDA_3]
FW_VERSIONS[CAR.MAZDA_6_TI] = FW_VERSIONS[CAR.MAZDA_6]

# GEN3 variants: no FW_VERSIONS captured yet (no real hardware data available)
FW_VERSIONS[CAR.MAZDA_3_2023] = {}
FW_VERSIONS[CAR.MAZDA_CX_30_2023] = {}

# CAN fingerprint for GEN3 CX-30 (copied from source fork MoreTore/openpilot mazda-frogpilot)
FINGERPRINTS = {
